...
export default function ProfileUpdateScreen() {
  const { user, completeProfile, checkUsernameUnique, uploadProfilePhoto } =
    useAuth();
  ...
  const handleSubmit = async () => {
    ...
    console.log('Profile data being submitted:', {
      ...
      bio,
      interests,
      photoUri: photoUri ? 'photo selected' : 'no photo change',
    });
    ...
    try {
      ...
      console.log('Submitting updated profile data to Supabase...');
